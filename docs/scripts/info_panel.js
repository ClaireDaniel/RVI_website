async function draw_info_panel (postcodes) {
  ...
  if(data.length > 0) {
    [
      {header: "Name", value: "33", tooltip: "", close: true},
      ...
      {header: "Disabled", value: 19, tooltip_h:"Needs assistance with a core activity, because of long-term health condition, disability or old age (Census)"},
