function draw_info_panel (postcodes) {
  ...
  if(data.length > 0 && YEAR != 2011) {
    [
      ...
      {header: "Rent Stress", value: "rent_stress", tooltip_h: "Households in the lowest 40% of incomes paying more than 30% of household income on rent (Census)"},
      {header: "Number of Renters", value: "total_renters", tooltip_h: "Number of people living in rented dwellings based on place of enumeration (Census)"},
      {header: "Bonds Held", value: `${YEAR}_12`, tooltip_h:"Total rental bonds held by the Residential Tenancies Authority at end of June in the stated year. Approximates total number of tenancies in the private rental sector. (Rental bonds)"},
      {header: "Median Rent", value: `${YEAR.slice(-2)}_m_rent`, tooltip_h:"Median rent for new bonds lodged in each calendar year (Rental bonds)"},
      {header: "Unaffordable Rentals", value: `unaff_${YEAR==2016 ? 2017 : YEAR}`, tooltip_h:"Percentage of new tenancies commencing (per new bonds lodged) in each year that are affordable (less than 30% of income) for the average income households for the area (Rental Bonds, ABS Average Weekly Earnings)"},
      ...
      {header: "Public/Community Housing", value: "public_community", tooltip_h:"Public housing dwellings and community housing dwellings (Queensland Government open data)"},
      {header: "Boarding Houses", value: "boardinghouse", tooltip_h:"Registered rooming services (Queensland Government open data)"},
      {header: "Residential Parks", value: "residential_park", tooltip_h:"Dwellings on registered residential parks with manufactured homes (Queensland Government open data)"},
      ...
      {header: "Younger", value: "young", tooltip_h:"Number of renters aged 15 to 24 (census)  "},
      {header: "Older", value: "older", tooltip_h:"Number of renters aged 65 and over at (census)"},
      {header: "Unemployed", value: "unemployed", tooltip_h:"Number of renters unemployed (census)"},
      {header: "Single Parent", value: "single_parent", tooltip_h:"Number of households classified as one parent family (Census)"},
      {header: "Lower Education Level", value: "low_ed", tooltip_h:"Number of renters where highest level of education attained is Year 10 or below (Census)"},
      {header: "Need of Assistance", value: "assist", tooltip_h:"Needs assistance with a core activity, because of long-term health condition, disability or old age (Census)"},
      {header: "Indigenous", value: "indig", tooltip_h:"Household contains at least one person who is Aboriginal or Torres Strait Islander (Census)"},
      {header: "English Speakers", value:"english" , tooltip_h:"Main language used at home (Census)"},
