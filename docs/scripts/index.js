...
let THEMES = [
  ...
  { "name": "People Indicators (Renters)",
    "items": [
      { id: 3, display: true,  info_display: true, label: "Number of Renters",          tooltip: "Number of people living in a rental dwelling (Census)", legend: [0,0.125,0.25,0.375,0.50],    legend_format: d => d.toLocaleString(undefined,{style: 'percent', minimumfractiondigits:1, maximumFractionDigits:1}),   value: d => d.total_renters/d.total_persons, format: d => `${d.total_renters} (${(d.total_renters/d.total_persons).toLocaleString(undefined,{style: 'percent', minimumfractiondigits:2, maximumFractionDigits:2})})` },
      { id: 38, display: true, info_display: true, label: "Recently Moved",          tooltip: "Number of renters who recently moved (Census)", legend: [0,0.05,0.1,0.15,0.2],    legend_format: d => d.toLocaleString(undefined,{style: 'percent', minimumfractiondigits:1, maximumFractionDigits:1}),   value: d => d.recrenters/d.total_renters, format: d => `${d.recrenters} (${(d.recrenters/d.total_renters).toLocaleString(undefined,{style: 'percent', minimumfractiondigits:2, maximumFractionDigits:2})})` },
      { id: 14, display: true, info_display: true, label: "Younger",               tooltip: "Number of renters aged 15 to 24 (Census)", legend: [0,0.06,0.12,0.19,0.25],                                   legend_format: d => d.toLocaleString(undefined,{style: 'percent', minimumfractiondigits:1, maximumFractionDigits:1}), value: d => d.young/d.total_renters,         format: d => `${d.young} (${(d.young/d.total_renters).toLocaleString(undefined,{style: 'percent', minimumfractiondigits:2, maximumFractionDigits:2})})`},
      { id: 15, display: true, info_display: true, label: "Older",                 tooltip: "Number of renters aged 65 and over (Census)", legend: [0,0.06,0.12,0.19,0.25],                              legend_format: d => d.toLocaleString(undefined,{style: 'percent', minimumfractiondigits:1, maximumFractionDigits:1}), value: d => d.older/d.total_renters,         format: d => `${d.older} (${(d.older/d.total_renters).toLocaleString(undefined,{style: 'percent', minimumfractiondigits:2, maximumFractionDigits:2})})`},
      { id: 16, display: true, info_display: true, label: "Unemployed",            tooltip: "Number of renters unemployed (Census)", legend: [0,0.01,0.02,0.03,0.04],                                       legend_format: d => d.toLocaleString(undefined,{style: 'percent', minimumfractiondigits:1, maximumFractionDigits:1}), value: d => d.unemployed/d.total_renters,    format: d => `${d.unemployed} (${(d.unemployed/d.total_renters).toLocaleString(undefined,{style: 'percent', minimumfractiondigits:2, maximumFractionDigits:2})})`},
      { id: 17, display: true, info_display: true, label: "Single Parent",         tooltip: "Number of households classified as one parent family (Census)",                                                legend: [0,0.025,0.05,0.075,0.1], legend_format: d => d.toLocaleString(undefined,{style: 'percent', minimumfractiondigits:1, maximumFractionDigits:1}), value: d => d.single_parent/d.total_renters, format: d => `${d.single_parent} (${(d.single_parent/d.total_renters).toLocaleString(undefined,{style: 'percent', minimumfractiondigits:2, maximumFractionDigits:2})})`},
      { id: 18, display: true, info_display: true, label: "Lower Education Level", tooltip: "Number of renters where highest level of education attained is Year 10 or below (Census)",                     legend: [0,0.06,0.12,0.19,0.25], legend_format: d => d.toLocaleString(undefined,{style: 'percent', minimumfractiondigits:1, maximumFractionDigits:1}), value: d => d.low_ed/d.total_renters,        format: d => `${d.low_ed} (${(d.low_ed/d.total_renters).toLocaleString(undefined,{style: 'percent', minimumfractiondigits:2, maximumFractionDigits:2})})`},
      { id: 19, display: true, info_display: true, label: "Disabled",    tooltip: "Number of renters who needs assistance with a core activity, because of long-term health condition, disability or old age (Census)", legend: [0,0.025,0.05,0.075,0.1], legend_format: d => d.toLocaleString(undefined,{style: 'percent', minimumfractiondigits:1, maximumFractionDigits:1}), value: d => d.assist/d.total_renters,        format: d => `${d.assist} (${(d.assist/d.total_renters).toLocaleString(undefined,{style: 'percent', minimumfractiondigits:2, maximumFractionDigits:2})})`},
      { id: 20, display: true, info_display: true, label: "Indigenous",            tooltip: "Number of renters who are Aboriginal or Torres Strait Islander (Census)",                  legend: [0,0.12,0.25,0.37,0.50], legend_format: d => d.toLocaleString(undefined,{style: 'percent', minimumfractiondigits:1, maximumFractionDigits:1}), value: d => d.indig/d.total_renters,         format: d => `${d.indig} (${(d.indig/d.total_renters).toLocaleString(undefined,{style: 'percent', minimumfractiondigits:2, maximumFractionDigits:2})})`},
