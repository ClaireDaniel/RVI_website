...
function draw_controls() {
  ...
  // --- YEAR SELECTION ---
  // Creates radio buttons to switch between Census years
  let year;
  ...
  // Update global YEAR and refresh all dependent UI components when a new year is selected
  ...
  // Creates an autocomplete search input using a <datalist>
  ...
  // Populate the autocomplete list with regions filtered by the current state and year
  ...
  // Trigger selection logic when a user chooses a region from the search
  ...
  // --- THEME SELECTION ---
  // Generates a dropdown to switch between different vulnerability indicators
  ...
  // Organize the dropdown into groups (optgroups) based on THEMES in index.js
  ...
  // Update global THEME and refresh map layers and legend on change
  ...
  // Make the controls visible in the panel
